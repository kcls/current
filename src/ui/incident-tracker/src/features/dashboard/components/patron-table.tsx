...
import type { SortState } from '../../../shared/hooks/use-sort-state';
...
export const PatronTable: React.FC<PatronTableProps> = ({
  ...
  const initialLoading = loading && patrons.length === 0;
  ...
  return (
    <TableContainer component={Paper} variant="outlined">
      <Table size="small">
        <TableHead>
          <TableRow>
            <SortableHeadCell label="First Name" sortKey="first_name" sort={sort} onSort={onSort} />
            <SortableHeadCell label="Last Name" sortKey="last_name" sort={sort} onSort={onSort} />
            <TableCell>Library Card</TableCell>
            <SortableHeadCell label="Lift Date" sortKey="lift_date" sort={sort} onSort={onSort} />
